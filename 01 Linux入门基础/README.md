...
- [下载完整教材](https://github.com/He-qingchuan/BioinformaticsPathfinder/releases/download/linux-v1.0.0/linux-v1.0.0.zip)（联网）
...
本版本为 `linux-v1.0.0`。更新摘要见 [CHANGELOG.md](CHANGELOG.md)，验证范围见 [qa/README.md](qa/README.md)。旧 Linux 教材保留在重构前的 Git 历史（`cbd3352`）；本轮重新编写正文与案例，不依赖旧教程或公众号阅读前提。
