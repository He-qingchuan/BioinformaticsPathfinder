...
这是一套面向初学者的完整 Bulk RNA-seq 互动课程，包含 16 个学习地点、23 张真实结果图、14 张原理插图、178 项中英术语、案例资料、源码与离线验收记录。
...
- [下载最新完整版本](https://github.com/He-qingchuan/BioinformaticsPathfinder/releases/latest)
- [查看课程源码与离线包](03%20Bulk%20RNA-seq/README.md)
...
- `01Linux入门基础+R入门基础`：Linux 与 R 入门。
- `02 Python入门基础`：Python、Pandas、Matplotlib 与差异表达分析示例。
